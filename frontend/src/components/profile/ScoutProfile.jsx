...
const ScoutProfile = ({ profile, currentUserId, isFollowing, buttonLoading, onFollow, onUnfollow, onProfilePictureUpdate }) => {
  const {
    connections = 0,
    athletesViewed = 0,
    coachesViewed = 0,
  ...
  return (
    <div>
      <ProfileHeader profile={profile} currentUserId={currentUserId} isFollowing={isFollowing} buttonLoading={buttonLoading} onFollow={onFollow} onUnfollow={onUnfollow} onProfilePictureUpdate={onProfilePictureUpdate} />
