      ...
      <div className="flex-1 flex flex-col justify-center h-full relative">
        ...
        <div className="flex flex-col items-center w-full mb-2">
          <span className="text-2xl font-bold text-gray-900 text-center block w-full flex items-center justify-center">
            ...
            <span className="ml-2">
              <UserStatusBadge user={profile} isOwnProfile={isOwnProfile} />
            </span>
            {/* Star icon for scouts */}
            {isScout && currentUserId && profile.id !== currentUserId && (
              <button
                className="ml-2 p-1 hover:bg-gray-100 rounded-full transition-colors duration-150 focus:outline-none"
              ...
              >
                {starred ? (
                  ...
                  <svg className="w-6 h-6 text-gray-400 hover:text-yellow-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.286 3.967a1 1 0 00.95.69h4.175c.969 0 1.371 1.24.588 1.81l-3.38 2.455a1 1 0 00-.364 1.118l1.287 3.966c.3.922-.755 1.688-1.54 1.118l-3.38-2.454a1 1 0 00-1.175 0l-3.38 2.454c-.784.57-1.838-.196-1.54-1.118l1.287-3.966a1 1 0 00-.364-1.118L2.05 9.394c-.783-.57-.38-1.81.588-1.81h4.175a1 1 0 00.95-.69l1.286-3.967z"/>
                  </svg>
                )}
              </button>
            )}
